...
public:		
	...
	glm::vec2 line1A = glm::vec2(200, 200);
	glm::vec2 line1B = glm::vec2(600, 200);
	glm::vec2 line2A = glm::vec2(200, 200);
	glm::vec2 line2B = glm::vec2(200, 600);
	glm::vec2 line3A = glm::vec2(200, 600);
	glm::vec2 line3B = glm::vec2(600, 600);
	glm::vec2 line4A = glm::vec2(600, 600);
	glm::vec2 line4B = glm::vec2(600, 200);
